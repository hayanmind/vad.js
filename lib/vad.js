export default function(options) {
  ...
  this.options = {
    ...
    // source: null, // Removed option
    // context: null, // Removed option
    // The followings are newly added optoins
    sampleRate: 16000,
  };
  ...
  */
  ...
  // Replacement this.options.context.sampleRate;
  this.hertzPerBin = /* this.options.context.sampleRate */this.options.sampleRate / this.options.fftSize;
  this.iterationFrequency = /* this.options.context.sampleRate */this.options.sampleRate/ this.options.bufferLen;
  ...
  */
  ...
  this.monitor = function() {
    ...
    return { vadClass: this.vadState ? 'voiced' : 'unvoiced' };
    // return signal;
  }
